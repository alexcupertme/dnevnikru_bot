...
export declare type TPersonSchool = {
    id: number;
    id_str: string;
    name: string;
    educationType: string;
...
export declare type TIncludedCity = {
    id: number;
    id_str: string;
    name: string;
    regionId: number;
...
export declare type TSchoolUser = {
    id: number;
    id_str: string;
    userId: number;
    userId_str: string;
...
export declare type TSchoolParameters = {
    schoolId: number;
    schoolId_str: string;
    municipality: string;
    fullName: string;
